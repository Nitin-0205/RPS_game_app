...
import { StyleSheet, Text, View, Button, Image, TouchableOpacity, SliderComponent } from 'react-native';
      ...
      </View>
      {
        again ?
          <View style={styles.playAgnCont}>
            <View style = {{position:"absolute",width:"100%",height:"100%",backgroundColor: "#222",opacity:0.8,}}></View>
            <View style={styles.playAgnBox}>
              ...
              <View style={{width:"100%",flexDirection: "row", justifyContent: "space-evenly" }}>
                <Button title="Play Again" onPress={() => { setagain(false);HandlePlaySound(Sounds.click)}}></Button>
                <Button title="Back" onPress={()=>{BckToHome(); HandlePlaySound(Sounds.click)}}></Button>
              </View>
            </View>
          </View>
          : <></>
